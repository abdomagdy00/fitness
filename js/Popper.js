...
!(function (e, t) {
	...
	function i(e, t) {
		...
		return (
			o(e) &&
				t &&
				((t = e.offsetHeight),
				0 < (e = e.offsetWidth) && (r = I(n.width) / e || 1),
				0 < t && (i = I(n.height) / t || 1)),
			{
				width: n.width / r,
				height: n.height / i,
				top: n.top / i,
	...
	function u(e, n, r) {
		...
		if ((c = o(n))) {
			...
			(c = I(d.width) / n.offsetWidth || 1),
				(d = I(d.height) / n.offsetHeight || 1),
				(c = 1 !== c || 1 !== d);
		}
	...
	function y(e) {
		for (
			var n = t(e), r = g(e);
			r && 0 <= ["table", "td", "th"].indexOf(s(r)) && "static" === c(r).position;
		...
		return (
			...
			((r = (r = [].concat(t, [r])).reduce(function (t, n) {
				return (
					(n = E(e, n)),
					(t.top = V(n.top, t.top)),
					(t.right = N(n.right, t.right)),
					(t.bottom = N(n.bottom, t.bottom)),
	...
	function W(e, t) {
		...
		var p = o.altBoundary,
			c = void 0 !== p && p;
		(o = M("number" != typeof (o = void 0 === (o = o.padding) ? 0 : o) ? o : k(o, _))),
			(p = e.rects.popper),
			(a = D(
	...
	function T(e) {
		...
		if (u) {
			var x = y(o),
				...
				j = "clientWidth";
			x === t(o) &&
				"static" !== c((x = f(o))).position &&
				"absolute" === p &&
				((O = "scrollHeight"), (j = "scrollWidth")),
				("top" !== i && (("left" !== i && "right" !== i) || "end" !== a)) ||
					((b = "bottom"),
					(h -= (e && w.visualViewport ? w.visualViewport.height : x[O]) - r.height),
					(h *= l ? 1 : -1)),
				("left" !== i && (("top" !== i && "bottom" !== i) || "end" !== a)) ||
					((g = "right"),
					(d -= (e && w.visualViewport ? w.visualViewport.width : x[j]) - r.width),
					(d *= l ? 1 : -1));
		}
		return (
			...
			l
				...
				: Object.assign(
						{},
						o,
						(((n = {})[b] = s ? h + "px" : ""), (n[g] = m ? d + "px" : ""), (n.transform = ""), n)
				  )
		);
	}
	function R(e) {
				...
				return (
					...
					function () {
						Object.keys(t.elements).forEach(function (e) {
							var r = t.elements[e],
								i = t.attributes[e] || {};
							(e = Object.keys(t.styles.hasOwnProperty(e) ? t.styles[e] : n[e]).reduce(
								function (e, t) {
									return (e[t] = ""), e;
								},
								{}
			...
			fn: function (e) {
				...
				if (((s = { x: 0, y: 0 }), o)) {
					if (r) {
						...
						var B = t.modifiersData["arrow#persistent"]
							? t.modifiersData["arrow#persistent"].padding
							: { top: 0, right: 0, bottom: 0, left: 0 };
						(w = B[w]),
							(O = B[O]),
							(k = V(0, N(h[j], k[j]))),
							(M = l ? h[j] / 2 - P - k - w - v.mainAxis : M - k - w - v.mainAxis),
							(l = l ? -h[j] / 2 + P + k + O + v.mainAxis : c + k + O + v.mainAxis),
							(j = (j = t.elements.arrow && y(t.elements.arrow))
								? "y" === u
									? j.clientTop || 0
									: j.clientLeft || 0
								: 0),
							(P = null != (b = null == g ? void 0 : g[u]) ? b : 0),
							(b = r + l - P),
							(E = a ? N(E, r + M - P - j) : E),
							(b = a ? V(D, b) : D),
							(b = V(E, N(r, b))),
					...
					if (i)
						(r = "y" === n ? "height" : "width"),
							(b = (i = o[n]) + f["x" === u ? "top" : "left"]),
							(f = i - f["x" === u ? "bottom" : "right"]),
							(p = -1 !== ["top", "left"].indexOf(p)),
							(u = null != (H = null == g ? void 0 : g[n]) ? H : 0),
							(H = p ? b : i - h[r] - m[r] - u + v.altAxis),
							(h = p ? i + h[r] + m[r] - u - v.altAxis : f),
							a && p
								? (H = (H = V(H, N(i, h))) > h ? h : H)
								: (H = V(a ? H : b, N(i, a ? h : f))),
							(o[n] = H),
			...
			fn: function (e) {
				...
				if (((e = L(s)), (s = 0 <= ["left", "right"].indexOf(s) ? "height" : "width"), i && a)) {
					...
					(a = a[e] - n.rects.reference[e]),
						(a =
							(i = (i = y(i)) ? ("y" === e ? i.clientHeight || 0 : i.clientWidth || 0) : 0) /
								2 -
							f[s] / 2 +
							(l / 2 - a / 2)),
						(s = V(r[p], N(a, i - f[s] - r[c]))),
